 ...
 * Description
 */
public class MainNewsEventsAdapter  extends RecyclerView.Adapter<MainNewsEventsAdapter.ViewHolder> {
    ...
    public MainNewsEventsAdapter(List<NewsDataModel.NewsData> data) {
    ...
    @NonNull
    @Override
    public MainNewsEventsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        View view = inflater.inflate(R.layout.item_main_news_events, parent, false);
        MainNewsEventsAdapter.ViewHolder vh = new MainNewsEventsAdapter.ViewHolder(view);
        return vh;
    }

    // position에 해당하는 데이터를 뷰홀더의 아이템뷰에 표시
    @Override
    public void onBindViewHolder(@NonNull MainNewsEventsAdapter.ViewHolder holder, int position) {
